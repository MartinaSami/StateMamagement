...
import 'package:statemanagmenetstacked/ui/views/home/start_view/start_view_model.dart';

class StartView extends StatelessWidget {
  final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();

  StartView({required Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<StartViewModel>.reactive(
      ...
      builder: (context, StartViewModel model, _) {
        return Scaffold(
          key: scaffoldKey,
