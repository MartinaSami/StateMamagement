...
class WaveLoadingBubble extends StatelessWidget {
  const WaveLoadingBubble({
    this.bubbleDiameter = 500.0,
    this.loadingCircleWidth = 10.0,
    this.waveInsetWidth = 10.0,
...
class WaveLoadingBubblePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // canvas.clipPath(_buildDropletPath(), doAntiAlias: true);
    canvas.drawPath(backgroundWavePath, backgroundWavePaint);
    canvas.drawPath(foregroundWavePath, foregroundWavePaint);
  }

  Path _buildDropletPath() {
    final size = Size(200, 150);

    Path path_0 = Path();
    path_0.moveTo(size.width * 0.5377612, size.height * 0.01240935);
    path_0.cubicTo(
        size.width * 0.5158122,
        size.height * -0.004136446,
        size.width * 0.4773980,
        size.height * -0.004136446,
        size.width * 0.4554510,
        size.height * 0.01240935);
    path_0.cubicTo(size.width * 0.4060633, size.height * 0.05377477, 0,
        size.height * 0.4260692, 0, size.height * 0.6163554);
    path_0.cubicTo(
        0,
        size.height * 0.8231862,
        size.width * 0.2194918,
        size.height * 0.9886508,
        size.width * 0.4938612,
        size.height * 0.9886508);
    path_0.cubicTo(
        size.width * 0.7682286,
        size.height * 0.9886508,
        size.width * 0.9877204,
        size.height * 0.8231862,
        size.width * 0.9877204,
        size.height * 0.6163554);
    path_0.cubicTo(
        size.width * 0.9877204,
        size.height * 0.4260692,
        size.width * 0.5816592,
        size.height * 0.05377477,
        size.width * 0.5377612,
        size.height * 0.01240935);
    path_0.close();

    Paint paint_0_fill = Paint()..style = PaintingStyle.fill;
    paint_0_fill.color = Color(0xffA8EAFF).withOpacity(1.0);
    return path_0;
  }
